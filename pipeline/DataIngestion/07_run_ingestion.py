...
PIPELINE_STEPS = [
    "pipeline/DataIngestion/01_process_cdc.py",
    "pipeline/DataIngestion/02_process_usda.py",
    "pipeline/DataIngestion/03_process_chrr_census.py",
    "pipeline/DataIngestion/04_process_census_acs.py",
    "pipeline/DataIngestion/05_master_dataset.py",
    "pipeline/DataIngestion/06_load_to_sql.py"
]
